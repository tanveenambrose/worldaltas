...
function Footer() {
  ...
  return (
    <>
    <div className="footer bg-neutral text-neutral-content rounded-t-3xl">


  <div className=" container mx-auto grid grid-cols-3 pb-4 pt-6  ">
      {
  ...
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    ...
    <NavLink to="https://www.facebook.com/rakibulalamtanveen/" target='_blank'>
